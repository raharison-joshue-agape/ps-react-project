#!/usr/bin/env zsh
# mantine.zsh — Crée un projet Vite + React 19 + Mantine + TypeScript pré-configuré.

new_react_vite_mantine() {
    ...
    echo "Creating project: $PROJECT_NAME (Vite + React 19 + Mantine + TypeScript)"
