#!/usr/bin/env zsh
# headless.zsh — Crée un projet Vite + React 19 + Headless UI + TypeScript pré-configuré.

new_react_vite_headless() {
    ...
    echo "Creating project: $PROJECT_NAME (Vite + React 19 + Headless UI + TypeScript)"
