#!/usr/bin/env zsh
# heroUI.zsh — Crée un projet Vite + React 19 + Hero UI + TypeScript pré-configuré.

new_react_vite_hero_ui() {
    ...
    echo "Creating project: $PROJECT_NAME (Vite + React 19 + Hero UI + TypeScript)"
