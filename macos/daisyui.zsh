#!/usr/bin/env zsh
# daisyui.zsh — Crée un projet Vite + React 19 + DaisyUI + TypeScript pré-configuré.

new_react_vite_daisy_ui() {
    ...
    echo "Creating project: $PROJECT_NAME (Vite + React 19 + DaisyUI + TypeScript)"
