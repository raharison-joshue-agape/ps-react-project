#!/usr/bin/env zsh
# shadecnUI.zsh — Crée un projet Vite + React 19 + Shadcn UI + TypeScript pré-configuré.

new_react_vite_shadecn_ui() {
    ...
    echo "Creating project: $PROJECT_NAME (Vite + React 19 + Shadcn UI + TypeScript)"
...
EOF
    ...
    mv -f src/index.css src/styles/index.css
