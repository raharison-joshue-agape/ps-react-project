$react_vite_arco_project_config_content = @'
...
'@
$react_vite_arco_project_tsconfig_app_content = @'
{
    "compilerOptions": {
...
'@
$react_vite_arco_project_main_content = @'
...
'@
$react_vite_arco_project_theme_content = @'
...
'@
$react_vite_arco_project_style_content = @'
...
'@
$react_vite_arco_project_route_content = @'
...
'@
$react_vite_arco_project_home_page_content = @'
...
'@
$react_vite_arco_project_not_found_page_content = @'
import { Button, Tag, Typography } from '@arco-design/web-react';
...
'@
$react_vite_arco_project_default_layout_content = @'
...
'@
$react_vite_arco_project_toggle_mode_content = @'
...
<#
.SYNOPSIS
    Crée un projet Vite + React 19 + Arco Design + TypeScript pré-configuré.

.DESCRIPTION
    Installe Arco Design (ByteDance) et Arco Icons, puis génère le layout, les pages Home/404 et le sélecteur de thème (Clair / Sombre / Système via l attribut arco-theme sur body).
...
#>
function New-ReactViteArco {
    param([string]$PROJECT_NAME)

    if (-not $PROJECT_NAME) { $PROJECT_NAME = Read-Host "Project name" }

    Write-Host "Creating project: $PROJECT_NAME (Vite + React 19 + Arco Design + TypeScript)"
    ...
    Set-Content "vite.config.ts" -Value $react_vite_arco_project_config_content -Encoding UTF8
    Set-Content "tsconfig.app.json" -Value $react_vite_arco_project_tsconfig_app_content -Encoding UTF8
    Set-Content "src/main.tsx" -Value $react_vite_arco_project_main_content -Encoding UTF8
    Set-Content "src/theme/ThemeContext.tsx" -Value $react_vite_arco_project_theme_content -Encoding UTF8
    Set-Content "src/styles/index.css" -Value $react_vite_arco_project_style_content -Encoding UTF8
    Set-Content "src/routes/index.tsx" -Value $react_vite_arco_project_route_content -Encoding UTF8
    Set-Content "src/pages/Home.tsx" -Value $react_vite_arco_project_home_page_content -Encoding UTF8
    Set-Content "src/pages/NotFound.tsx" -Value $react_vite_arco_project_not_found_page_content -Encoding UTF8
    Set-Content "src/layouts/default.tsx" -Value $react_vite_arco_project_default_layout_content -Encoding UTF8
    Set-Content "src/components/ToggleMode.tsx" -Value $react_vite_arco_project_toggle_mode_content -Encoding UTF8
