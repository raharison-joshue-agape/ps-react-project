$react_vite_radix_project_config_content = @'
...
'@
$react_vite_radix_project_tsconfig_app_content = @'
{
    "compilerOptions": {
...
'@
$react_vite_radix_project_main_content = @'
...
'@
$react_vite_radix_project_theme_provider_content = @'
...
'@
$react_vite_radix_project_style_content = @'
@import 'tailwindcss';

@custom-variant dark (&:is(.dark *));
'@
$react_vite_radix_project_route_content = @'
...
'@
$react_vite_radix_project_home_page_content = @'
...
'@
$react_vite_radix_project_not_found_page_content = @'
import ToggleMode from '@/components/ToggleMode';
...
'@
$react_vite_radix_project_default_layout_content = @'
...
'@
$react_vite_radix_project_toggle_mode_content = @'
...
<#
.SYNOPSIS
    Crée un projet Vite + React 19 + Radix UI + TypeScript pré-configuré.

.DESCRIPTION
    Installe Radix UI, TailwindCSS et Lucide Icons, puis génère le layout, les pages Home/404 et le sélecteur de thème (Clair / Sombre / Système via un menu Radix et la classe .dark).
...
#>
function New-ReactViteRadix {
    param([string]$PROJECT_NAME)

    if (-not $PROJECT_NAME) { $PROJECT_NAME = Read-Host "Project name" }

    Write-Host "Creating project: $PROJECT_NAME (Vite + React 19 + Radix UI + TypeScript)"
    ...
    Set-Content "vite.config.ts" -Value $react_vite_radix_project_config_content -Encoding UTF8
    Set-Content "tsconfig.app.json" -Value $react_vite_radix_project_tsconfig_app_content -Encoding UTF8
    Set-Content "src/main.tsx" -Value $react_vite_radix_project_main_content -Encoding UTF8
    Set-Content "src/theme/ThemeProvider.tsx" -Value $react_vite_radix_project_theme_provider_content -Encoding UTF8
    Set-Content "src/styles/index.css" -Value $react_vite_radix_project_style_content -Encoding UTF8
    Set-Content "src/routes/index.tsx" -Value $react_vite_radix_project_route_content -Encoding UTF8
    Set-Content "src/pages/Home.tsx" -Value $react_vite_radix_project_home_page_content -Encoding UTF8
    Set-Content "src/pages/NotFound.tsx" -Value $react_vite_radix_project_not_found_page_content -Encoding UTF8
    Set-Content "src/layouts/default.tsx" -Value $react_vite_radix_project_default_layout_content -Encoding UTF8
    Set-Content "src/components/ToggleMode.tsx" -Value $react_vite_radix_project_toggle_mode_content -Encoding UTF8
