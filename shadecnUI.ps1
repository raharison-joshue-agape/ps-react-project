    ...
    return (
        <main className="min-h-screen flex flex-col items-center justify-center px-6 text-center bg-linear-to-br from-cyan-50 via-purple-50 to-pink-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 transition-colors">
            ...
            <p className="text-lg sm:text-xl md:text-2xl text-gray-600 dark:text-gray-300 max-w-2xl mb-10 leading-relaxed">
                ...
                <span className="font-semibold text-cyan-600 dark:text-cyan-400"> Shadecn UI</span>,
...
export default function NotFound() {
    ...
    return (
        <main className="min-h-screen flex flex-col items-center justify-center px-6 text-center bg-linear-to-br from-cyan-50 via-purple-50 to-pink-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 transition-colors">
            <BanIcon size={50} className="text-pink-600 dark:text-pink-400 text-7xl mb-6 animate-pulse" />
...
function New-ReactViteShadecnUi {
    ...
    Write-Host "Creating project: $PROJECT_NAME (Vite + React 18 + Shadecn UI + TypeScript)"
    ...
    Set-Content "src/styles/index.css" -Value $react_vite_shadecn_project_style_content -Encoding UTF8

    Write-Host "Installing Shadecn UI dependencies..."
